...
public class DatabaseHelperFridge extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "ProductDBFridge";
    private static final int DATABASE_VERSION = 1;

    public static final String TABLE_NAME = "ProductFridge";
    ...
    public DatabaseHelperFridge(Context context) {
